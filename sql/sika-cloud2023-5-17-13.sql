/*
 ...
 Source Host           : 10.144.227.237:3306
...
INSERT INTO `sys_user` VALUES (2, 105, 'wc', '吴畅', '00', '2235569493@qq.com', '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2023-04-18 01:05:28', 'admin', '2023-04-18 01:05:28', '', NULL, '测试员');
INSERT INTO `sys_user` VALUES (100, 200, 'spirit223', '小吴来哩', '00', '744981991@qq.com', '13727272464', '0', '', '$2a$10$z/Dcd0.z05eAf3FU4x3qseAfH8Cnmtat/KKAw1CbzBrinwAnLkux6', '0', '0', '', NULL, 'admin', '2023-05-15 15:02:44', '', NULL, NULL);
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资料表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `task_submit`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '提交记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `task_task`  (
  ...
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '任务表' ROW_FORMAT = Dynamic;
